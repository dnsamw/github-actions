    ...
    <section class="2-col-grid">
      ...
      <div class="flexbox">
        <div class="leftside grid-card">
          ...
          <ul class="custom-bullet doodle-dot">
            <li>
              Targeted advertising campaigns to reach the right people at the right time
            </li>
            <li>
              Increased conversions, more cost-effective spending, and higher ROI
            </li>
          </ul>
        </div>
        <div class="rightside grid-card">
      ...
      <div class="flexbox">
        <div class="leftside grid-card">
          <h1>Utilise Data Analytics</h1>
          <ul class="custom-bullet doodle-dot">
            <li>Utilise data analytics to optimize marketing efforts</li>
            <li>Understand what's working and what can be improved</li>
            <li>
              More efficient marketing spending, increased conversions, and higher ROI
            </li>
          </ul>
        </div>
        <div class="rightside grid-card">
