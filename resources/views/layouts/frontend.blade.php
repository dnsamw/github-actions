...
<html lang="en">
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-7M4P1X7ZN3"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-7M4P1X7ZN3');
    </script>
...
<!-- FOOTER START -->
    ...
    <div class="footer-section">
            ...
            <div class="row link-address">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="footer-contact">
                  <h3>Get In Touch</h3>
                  <p><i class="fa fa-phone-alt"></i><a href="tel:+03330113630">0333 011 3630</a></p>
                  <p><i class="fa fa-envelope"></i> <a href="mailto:chimps@orderchimps.com">chimps@orderchimps.com</a></p>
                  <div class="footer-social">
                    <a href="https://twitter.com/orderchimps"><i class="fab fa-twitter"></i></a>
      ...
      <div class="copyright">
        <div class="row">
          <div class="col-md-6">
            <p>
              &copy; <a href="https://orderchimps.com">OrderChimps</a>  All Right Reserved. <?php echo date("Y"); ?>
            </p>
          </div>
        </div>
        {{-- <div class="footer-social">
  ...
  <script src="{{asset('/dist/js/text-slider.js')}}"></script>
        ...
        <script type="text/javascript">
          ...
          s1.async=true;
          s1.src='https://embed.tawk.to/624d892dc72df874911d5968/1fvvdvmrc';
          s1.charset='UTF-8';
