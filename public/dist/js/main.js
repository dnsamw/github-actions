document.addEventListener("DOMContentLoaded", function () {
    ...
    toggleFAQs.forEach(function (toggleFAQ) {
        ...
        toggleFAQ.addEventListener("click", function (event) {
            ...
            if (event.target.nextElementSibling != null) {
                ...
                event.target
                    .querySelector("i")
                    .classList.toggle("fa-plus-circle");
                event.target
                    .querySelector("i")
                    .classList.toggle("fa-minus-circle");
            } else {
                console.log("Clicked on Icon");
                event.target.parentElement.classList.toggle("active-faq");
    ...
    let three_kf = gsap.timeline({
        yPercent: 90,
        scrollTrigger: {
            trigger: ".txt-slider-container",
            start: "-=700",
            end: "bottom bottom",
            onEnter: () => {
                //console.log("KPI TRIGGER Enter");
    ...
    three_kf.to(
        ...
        {
            // this is kept blank because the purpose here is only to triger the onleave event.
        },
        1
    );
